...
class Enum extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Enum', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ...
    ..aOM<$56.SourceContext>(4, _omitFieldNames ? '' : 'sourceContext', subBuilder: $56.SourceContext.create)
  ...
  /// The source context.
  @$pb.TagNumber(4)
  $56.SourceContext get sourceContext => $_getN(3);
  @$pb.TagNumber(4)
  set sourceContext($56.SourceContext v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSourceContext() => $_has(3);
  @$pb.TagNumber(4)
  void clearSourceContext() => clearField(4);
  @$pb.TagNumber(4)
  $56.SourceContext ensureSourceContext() => $_ensure(3);
...
class Option extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Option', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.protobuf'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOM<$8.Any>(2, _omitFieldNames ? '' : 'value', subBuilder: $8.Any.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $8.Any get value => $_getN(1);
  @$pb.TagNumber(2)
  set value($8.Any v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasValue() => $_has(1);
  @$pb.TagNumber(2)
  void clearValue() => clearField(2);
  @$pb.TagNumber(2)
  $8.Any ensureValue() => $_ensure(1);
}
