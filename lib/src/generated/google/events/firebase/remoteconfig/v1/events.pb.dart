...
class RemoteConfigUpdatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteConfigUpdatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.remoteconfig.v1'), createEmptyInstance: create)
    ..aOM<$54.RemoteConfigEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $54.RemoteConfigEventData.create)
  ...
  @$pb.TagNumber(1)
  $54.RemoteConfigEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($54.RemoteConfigEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $54.RemoteConfigEventData ensureData() => $_ensure(0);
}
