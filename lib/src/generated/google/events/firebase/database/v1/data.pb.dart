...
class ReferenceEventData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReferenceEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.database.v1'), createEmptyInstance: create)
    ..aOM<$7.Value>(1, _omitFieldNames ? '' : 'data', subBuilder: $7.Value.create)
    ..aOM<$7.Value>(2, _omitFieldNames ? '' : 'delta', subBuilder: $7.Value.create)
  ...
  'Will be removed in next major version')
  ReferenceEventData copyWith(void Function(ReferenceEventData) updates) => super.copyWith((message) => updates(message as ReferenceEventData)) as ReferenceEventData;
  ...
  @$pb.TagNumber(1)
  $7.Value get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($7.Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $7.Value ensureData() => $_ensure(0);

  /// The change in the reference data.
  @$pb.TagNumber(2)
  $7.Value get delta => $_getN(1);
  @$pb.TagNumber(2)
  set delta($7.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDelta() => $_has(1);
  @$pb.TagNumber(2)
  void clearDelta() => clearField(2);
  @$pb.TagNumber(2)
  $7.Value ensureDelta() => $_ensure(1);
}
