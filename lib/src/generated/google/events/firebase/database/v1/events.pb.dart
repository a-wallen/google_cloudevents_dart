...
class ReferenceCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReferenceCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.database.v1'), createEmptyInstance: create)
    ..aOM<$51.ReferenceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $51.ReferenceEventData.create)
  ...
  'Will be removed in next major version')
  ReferenceCreatedEvent copyWith(void Function(ReferenceCreatedEvent) updates) => super.copyWith((message) => updates(message as ReferenceCreatedEvent)) as ReferenceCreatedEvent;
  ...
  @$pb.TagNumber(1)
  $51.ReferenceEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($51.ReferenceEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $51.ReferenceEventData ensureData() => $_ensure(0);
}
...
class ReferenceUpdatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReferenceUpdatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.database.v1'), createEmptyInstance: create)
    ..aOM<$51.ReferenceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $51.ReferenceEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReferenceUpdatedEvent copyWith(void Function(ReferenceUpdatedEvent) updates) => super.copyWith((message) => updates(message as ReferenceUpdatedEvent)) as ReferenceUpdatedEvent;
...
class ReferenceDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReferenceDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.database.v1'), createEmptyInstance: create)
    ..aOM<$51.ReferenceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $51.ReferenceEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReferenceDeletedEvent copyWith(void Function(ReferenceDeletedEvent) updates) => super.copyWith((message) => updates(message as ReferenceDeletedEvent)) as ReferenceDeletedEvent;
...
class ReferenceWrittenEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ReferenceWrittenEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.database.v1'), createEmptyInstance: create)
    ..aOM<$51.ReferenceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $51.ReferenceEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReferenceWrittenEvent copyWith(void Function(ReferenceWrittenEvent) updates) => super.copyWith((message) => updates(message as ReferenceWrittenEvent)) as ReferenceWrittenEvent;
