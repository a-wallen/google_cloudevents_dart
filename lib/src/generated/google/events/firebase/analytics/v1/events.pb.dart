...
class AnalyticsLogWrittenEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AnalyticsLogWrittenEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.analytics.v1'), createEmptyInstance: create)
    ..aOM<$49.AnalyticsLogData>(1, _omitFieldNames ? '' : 'data', subBuilder: $49.AnalyticsLogData.create)
  ...
  'Will be removed in next major version')
  AnalyticsLogWrittenEvent copyWith(void Function(AnalyticsLogWrittenEvent) updates) => super.copyWith((message) => updates(message as AnalyticsLogWrittenEvent)) as AnalyticsLogWrittenEvent;
  ...
  @$pb.TagNumber(1)
  $49.AnalyticsLogData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($49.AnalyticsLogData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $49.AnalyticsLogData ensureData() => $_ensure(0);
}
