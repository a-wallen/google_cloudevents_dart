...
class TestMatrixCompletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TestMatrixCompletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.testlab.v1'), createEmptyInstance: create)
    ..aOM<$55.TestMatrixEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $55.TestMatrixEventData.create)
  ...
  @$pb.TagNumber(1)
  $55.TestMatrixEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($55.TestMatrixEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $55.TestMatrixEventData ensureData() => $_ensure(0);
}
