...
class AlertPublishedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AlertPublishedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.firebasealerts.v1'), createEmptyInstance: create)
    ..aOM<$53.AlertData>(1, _omitFieldNames ? '' : 'data', subBuilder: $53.AlertData.create)
  ...
  @$pb.TagNumber(1)
  $53.AlertData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($53.AlertData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $53.AlertData ensureData() => $_ensure(0);
}
