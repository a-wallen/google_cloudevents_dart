...
class UserCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.auth.v1'), createEmptyInstance: create)
    ..aOM<$50.AuthEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $50.AuthEventData.create)
  ...
  @$pb.TagNumber(1)
  $50.AuthEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($50.AuthEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $50.AuthEventData ensureData() => $_ensure(0);
}
