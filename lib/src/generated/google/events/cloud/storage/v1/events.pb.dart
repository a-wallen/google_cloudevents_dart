...
class ObjectFinalizedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ObjectFinalizedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.storage.v1'), createEmptyInstance: create)
    ..aOM<$43.StorageObjectData>(1, _omitFieldNames ? '' : 'data', subBuilder: $43.StorageObjectData.create)
  ...
  @$pb.TagNumber(1)
  $43.StorageObjectData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($43.StorageObjectData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $43.StorageObjectData ensureData() => $_ensure(0);
}
