...
class AppGatewayCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppGatewayCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.appgateways.v1'), createEmptyInstance: create)
    ..aOM<$15.AppGatewayEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $15.AppGatewayEventData.create)
  ...
  @$pb.TagNumber(1)
  $15.AppGatewayEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($15.AppGatewayEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $15.AppGatewayEventData ensureData() => $_ensure(0);
}
