...
class AppConnection_ApplicationEndpoint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppConnection.ApplicationEndpoint', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.appconnections.v1'), createEmptyInstance: create)
...
class AppConnection_Gateway extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppConnection.Gateway', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.appconnections.v1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(6)
  set l7psc($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(6)
...
class AppConnection extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppConnection', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.appconnections.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'labels', entryClassName: 'AppConnection.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.events.cloud.beyondcorp.appconnections.v1'))
...
class AppConnectionEventData extends $pb.GeneratedMessage {
  ...
  factory AppConnectionEventData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AppConnectionEventData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AppConnectionEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.appconnections.v1'), createEmptyInstance: create)
    ..aOM<AppConnection>(1, _omitFieldNames ? '' : 'payload', subBuilder: AppConnection.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AppConnectionEventData clone() => AppConnectionEventData()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AppConnectionEventData copyWith(void Function(AppConnectionEventData) updates) => super.copyWith((message) => updates(message as AppConnectionEventData)) as AppConnectionEventData;
  ...
  static $pb.PbList<AppConnectionEventData> createRepeated() => $pb.PbList<AppConnectionEventData>();
  @$core.pragma('dart2js:noInline')
  static AppConnectionEventData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AppConnectionEventData>(create);
  ...
  @$pb.TagNumber(1)
  set payload(AppConnection v) { setField(1, v); }
  @$pb.TagNumber(1)
