...
class MessagePublishedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MessagePublishedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.pubsub.v1'), createEmptyInstance: create)
    ..aOM<$40.MessagePublishedData>(1, _omitFieldNames ? '' : 'data', subBuilder: $40.MessagePublishedData.create)
  ...
  'Will be removed in next major version')
  MessagePublishedEvent copyWith(void Function(MessagePublishedEvent) updates) => super.copyWith((message) => updates(message as MessagePublishedEvent)) as MessagePublishedEvent;
  ...
  @$pb.TagNumber(1)
  $40.MessagePublishedData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($40.MessagePublishedData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $40.MessagePublishedData ensureData() => $_ensure(0);
}
