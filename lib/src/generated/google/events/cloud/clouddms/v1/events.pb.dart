...
class MigrationJobCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MigrationJobCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.clouddms.v1'), createEmptyInstance: create)
    ..aOM<$21.MigrationJobEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $21.MigrationJobEventData.create)
  ...
  @$pb.TagNumber(1)
  $21.MigrationJobEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($21.MigrationJobEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $21.MigrationJobEventData ensureData() => $_ensure(0);
}
...
class ConnectionProfileCreatedEvent extends $pb.GeneratedMessage {
  factory ConnectionProfileCreatedEvent({
    $21.ConnectionProfileEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionProfileCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.clouddms.v1'), createEmptyInstance: create)
    ..aOM<$21.ConnectionProfileEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $21.ConnectionProfileEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $21.ConnectionProfileEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($21.ConnectionProfileEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $21.ConnectionProfileEventData ensureData() => $_ensure(0);
}
