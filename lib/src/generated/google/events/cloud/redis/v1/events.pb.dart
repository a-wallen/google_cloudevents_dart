...
class InstanceCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.redis.v1'), createEmptyInstance: create)
    ..aOM<$41.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $41.InstanceEventData.create)
  ...
  @$pb.TagNumber(1)
  $41.InstanceEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($41.InstanceEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $41.InstanceEventData ensureData() => $_ensure(0);
}
...
class InstanceUpdatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceUpdatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.redis.v1'), createEmptyInstance: create)
    ..aOM<$41.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $41.InstanceEventData.create)
    ..hasRequiredFields = false
  ;
...
class InstanceDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.redis.v1'), createEmptyInstance: create)
    ..aOM<$41.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $41.InstanceEventData.create)
    ..hasRequiredFields = false
  ;
