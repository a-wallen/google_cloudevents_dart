...
class ClusterCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.ClusterEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.ClusterEventData.create)
  ...
  @$pb.TagNumber(1)
  $4.ClusterEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($4.ClusterEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $4.ClusterEventData ensureData() => $_ensure(0);
}
...
class ClusterUpdatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterUpdatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.ClusterEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.ClusterEventData.create)
    ..hasRequiredFields = false
  ;
...
class ClusterDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClusterDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.ClusterEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.ClusterEventData.create)
    ..hasRequiredFields = false
  ;
...
class InstanceCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.InstanceEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $4.InstanceEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($4.InstanceEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $4.InstanceEventData ensureData() => $_ensure(0);
}
...
class InstanceUpdatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceUpdatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.InstanceEventData.create)
    ..hasRequiredFields = false
  ;
...
class InstanceDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.InstanceEventData.create)
    ..hasRequiredFields = false
  ;
...
class BackupCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.BackupEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.BackupEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $4.BackupEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($4.BackupEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $4.BackupEventData ensureData() => $_ensure(0);
}
...
class BackupUpdatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupUpdatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.BackupEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.BackupEventData.create)
    ..hasRequiredFields = false
  ;
...
class BackupDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BackupDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.alloydb.v1'), createEmptyInstance: create)
    ..aOM<$4.BackupEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $4.BackupEventData.create)
    ..hasRequiredFields = false
  ;
