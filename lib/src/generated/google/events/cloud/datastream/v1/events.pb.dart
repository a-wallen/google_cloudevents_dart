...
class ConnectionProfileCreatedEvent extends $pb.GeneratedMessage {
  factory ConnectionProfileCreatedEvent({
    $27.ConnectionProfileEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionProfileCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastream.v1'), createEmptyInstance: create)
    ..aOM<$27.ConnectionProfileEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $27.ConnectionProfileEventData.create)
  ...
  @$pb.TagNumber(1)
  $27.ConnectionProfileEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($27.ConnectionProfileEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $27.ConnectionProfileEventData ensureData() => $_ensure(0);
}
...
class StreamCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StreamCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastream.v1'), createEmptyInstance: create)
    ..aOM<$27.StreamEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $27.StreamEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $27.StreamEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($27.StreamEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $27.StreamEventData ensureData() => $_ensure(0);
}
...
class PrivateConnectionCreatedEvent extends $pb.GeneratedMessage {
  factory PrivateConnectionCreatedEvent({
    $27.PrivateConnectionEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PrivateConnectionCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastream.v1'), createEmptyInstance: create)
    ..aOM<$27.PrivateConnectionEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $27.PrivateConnectionEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $27.PrivateConnectionEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($27.PrivateConnectionEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $27.PrivateConnectionEventData ensureData() => $_ensure(0);
}
...
class RouteCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RouteCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastream.v1'), createEmptyInstance: create)
    ..aOM<$27.RouteEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $27.RouteEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $27.RouteEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($27.RouteEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $27.RouteEventData ensureData() => $_ensure(0);
}
