...
import '../../../../rpc/code.pbenum.dart' as $28;
...
class StateCondition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StateCondition', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.eventarc.v1'), createEmptyInstance: create)
    ..e<$28.Code>(1, _omitFieldNames ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: $28.Code.OK, valueOf: $28.Code.valueOf, enumValues: $28.Code.values)
  ...
  @$pb.TagNumber(1)
  $28.Code get code => $_getN(0);
  @$pb.TagNumber(1)
  set code($28.Code v) { setField(1, v); }
  @$pb.TagNumber(1)
