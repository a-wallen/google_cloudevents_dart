...
class CertificateCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.certificatemanager.v1'), createEmptyInstance: create)
    ..aOM<$18.CertificateEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $18.CertificateEventData.create)
  ...
  @$pb.TagNumber(1)
  $18.CertificateEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($18.CertificateEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $18.CertificateEventData ensureData() => $_ensure(0);
}
...
class CertificateMapCreatedEvent extends $pb.GeneratedMessage {
  factory CertificateMapCreatedEvent({
    $18.CertificateMapEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateMapCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.certificatemanager.v1'), createEmptyInstance: create)
    ..aOM<$18.CertificateMapEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $18.CertificateMapEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $18.CertificateMapEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($18.CertificateMapEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $18.CertificateMapEventData ensureData() => $_ensure(0);
}
...
class CertificateMapEntryCreatedEvent extends $pb.GeneratedMessage {
  factory CertificateMapEntryCreatedEvent({
    $18.CertificateMapEntryEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateMapEntryCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.certificatemanager.v1'), createEmptyInstance: create)
    ..aOM<$18.CertificateMapEntryEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $18.CertificateMapEntryEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $18.CertificateMapEntryEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($18.CertificateMapEntryEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $18.CertificateMapEntryEventData ensureData() => $_ensure(0);
}
...
class DnsAuthorizationCreatedEvent extends $pb.GeneratedMessage {
  factory DnsAuthorizationCreatedEvent({
    $18.DnsAuthorizationEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsAuthorizationCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.certificatemanager.v1'), createEmptyInstance: create)
    ..aOM<$18.DnsAuthorizationEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $18.DnsAuthorizationEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $18.DnsAuthorizationEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($18.DnsAuthorizationEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $18.DnsAuthorizationEventData ensureData() => $_ensure(0);
}
...
class CertificateIssuanceConfigCreatedEvent extends $pb.GeneratedMessage {
  factory CertificateIssuanceConfigCreatedEvent({
    $18.CertificateIssuanceConfigEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CertificateIssuanceConfigCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.certificatemanager.v1'), createEmptyInstance: create)
    ..aOM<$18.CertificateIssuanceConfigEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $18.CertificateIssuanceConfigEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $18.CertificateIssuanceConfigEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($18.CertificateIssuanceConfigEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $18.CertificateIssuanceConfigEventData ensureData() => $_ensure(0);
}
