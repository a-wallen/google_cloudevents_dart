...
import '../../../../api/monitored_resource.pb.dart' as $9;
...
class LogEntryData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogEntryData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOM<AuditLog>(2, _omitFieldNames ? '' : 'protoPayload', subBuilder: AuditLog.create)
    ..aOS(4, _omitFieldNames ? '' : 'insertId')
    ..aOM<$9.MonitoredResource>(8, _omitFieldNames ? '' : 'resource', subBuilder: $9.MonitoredResource.create)
    ..aOM<$2.Timestamp>(9, _omitFieldNames ? '' : 'timestamp', subBuilder: $2.Timestamp.create)
    ..e<LogSeverity>(10, _omitFieldNames ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: LogSeverity.DEFAULT, valueOf: LogSeverity.valueOf, enumValues: LogSeverity.values)
    ..m<$core.String, $core.String>(11, _omitFieldNames ? '' : 'labels', entryClassName: 'LogEntryData.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.events.cloud.audit.v1'))
    ...
    ..aOM<$2.Timestamp>(24, _omitFieldNames ? '' : 'receiveTimestamp', subBuilder: $2.Timestamp.create)
  ...
  'Will be removed in next major version')
  LogEntryData copyWith(void Function(LogEntryData) updates) => super.copyWith((message) => updates(message as LogEntryData)) as LogEntryData;
  ...
  ///  the error.
  @$pb.TagNumber(8)
  $9.MonitoredResource get resource => $_getN(2);
  @$pb.TagNumber(8)
  set resource($9.MonitoredResource v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasResource() => $_has(2);
  @$pb.TagNumber(8)
  void clearResource() => clearField(8);
  @$pb.TagNumber(8)
  $9.MonitoredResource ensureResource() => $_ensure(2);
...
class LogEntryOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogEntryOperation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
...
class AuditLog extends $pb.GeneratedMessage {
  factory AuditLog({
    ...
    $7.Struct? serviceData,
    $7.Struct? request,
    $7.Struct? response,
    $7.Struct? metadata,
    $7.Struct? resourceOriginalState,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuditLog', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOM<$10.Status>(2, _omitFieldNames ? '' : 'status', subBuilder: $10.Status.create)
    ...
    ..aOM<$7.Struct>(15, _omitFieldNames ? '' : 'serviceData', subBuilder: $7.Struct.create)
    ..aOM<$7.Struct>(16, _omitFieldNames ? '' : 'request', subBuilder: $7.Struct.create)
    ..aOM<$7.Struct>(17, _omitFieldNames ? '' : 'response', subBuilder: $7.Struct.create)
    ..aOM<$7.Struct>(18, _omitFieldNames ? '' : 'metadata', subBuilder: $7.Struct.create)
    ..aOM<$7.Struct>(19, _omitFieldNames ? '' : 'resourceOriginalState', subBuilder: $7.Struct.create)
  ...
  @$pb.TagNumber(2)
  $10.Status get status => $_getN(0);
  @$pb.TagNumber(2)
  set status($10.Status v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(2)
  void clearStatus() => clearField(2);
  @$pb.TagNumber(2)
  $10.Status ensureStatus() => $_ensure(0);
  ...
  @$pb.TagNumber(15)
  $7.Struct get serviceData => $_getN(8);
  @$pb.TagNumber(15)
  set serviceData($7.Struct v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasServiceData() => $_has(8);
  @$pb.TagNumber(15)
  void clearServiceData() => clearField(15);
  @$pb.TagNumber(15)
  $7.Struct ensureServiceData() => $_ensure(8);
  ...
  /// name will be indicated in the `@type` property.
  @$pb.TagNumber(16)
  $7.Struct get request => $_getN(9);
  @$pb.TagNumber(16)
  set request($7.Struct v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasRequest() => $_has(9);
  @$pb.TagNumber(16)
  void clearRequest() => clearField(16);
  @$pb.TagNumber(16)
  $7.Struct ensureRequest() => $_ensure(9);
  ...
  /// name will be indicated in the `@type` property.
  @$pb.TagNumber(17)
  $7.Struct get response => $_getN(10);
  @$pb.TagNumber(17)
  set response($7.Struct v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasResponse() => $_has(10);
  @$pb.TagNumber(17)
  void clearResponse() => clearField(17);
  @$pb.TagNumber(17)
  $7.Struct ensureResponse() => $_ensure(10);

  /// Other service-specific data about the request, response, and other
  /// information associated with the current audited event.
  @$pb.TagNumber(18)
  $7.Struct get metadata => $_getN(11);
  @$pb.TagNumber(18)
  set metadata($7.Struct v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasMetadata() => $_has(11);
  @$pb.TagNumber(18)
  void clearMetadata() => clearField(18);
  @$pb.TagNumber(18)
  $7.Struct ensureMetadata() => $_ensure(11);
  ...
  @$pb.TagNumber(19)
  $7.Struct get resourceOriginalState => $_getN(12);
  @$pb.TagNumber(19)
  set resourceOriginalState($7.Struct v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasResourceOriginalState() => $_has(12);
  @$pb.TagNumber(19)
  void clearResourceOriginalState() => clearField(19);
  @$pb.TagNumber(19)
  $7.Struct ensureResourceOriginalState() => $_ensure(12);
...
class AuthenticationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthenticationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'principalEmail')
    ..aOS(2, _omitFieldNames ? '' : 'authoritySelector')
    ..aOM<$7.Struct>(4, _omitFieldNames ? '' : 'thirdPartyPrincipal', subBuilder: $7.Struct.create)
  ...
  /// name will be indicated in the `@type` property.
  @$pb.TagNumber(4)
  $7.Struct get thirdPartyPrincipal => $_getN(2);
  @$pb.TagNumber(4)
  set thirdPartyPrincipal($7.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasThirdPartyPrincipal() => $_has(2);
  @$pb.TagNumber(4)
  void clearThirdPartyPrincipal() => clearField(4);
  @$pb.TagNumber(4)
  $7.Struct ensureThirdPartyPrincipal() => $_ensure(2);
...
class AuthorizationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthorizationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'resource')
    ..aOS(2, _omitFieldNames ? '' : 'permission')
    ..aOB(3, _omitFieldNames ? '' : 'granted')
    ..aOM<$11.AttributeContext_Resource>(5, _omitFieldNames ? '' : 'resourceAttributes', subBuilder: $11.AttributeContext_Resource.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set resourceAttributes($11.AttributeContext_Resource v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class RequestMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RequestMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'callerIp')
    ..aOS(2, _omitFieldNames ? '' : 'callerSuppliedUserAgent')
    ..aOS(3, _omitFieldNames ? '' : 'callerNetwork')
    ..aOM<$11.AttributeContext_Request>(7, _omitFieldNames ? '' : 'requestAttributes', subBuilder: $11.AttributeContext_Request.create)
    ..aOM<$11.AttributeContext_Peer>(8, _omitFieldNames ? '' : 'destinationAttributes', subBuilder: $11.AttributeContext_Peer.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set requestAttributes($11.AttributeContext_Request v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set destinationAttributes($11.AttributeContext_Peer v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class ResourceLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ResourceLocation', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
...
class ServiceAccountDelegationInfo_FirstPartyPrincipal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccountDelegationInfo.FirstPartyPrincipal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'principalEmail')
    ..aOM<$7.Struct>(2, _omitFieldNames ? '' : 'serviceMetadata', subBuilder: $7.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $7.Struct get serviceMetadata => $_getN(1);
  @$pb.TagNumber(2)
  set serviceMetadata($7.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasServiceMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearServiceMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $7.Struct ensureServiceMetadata() => $_ensure(1);
}
...
class ServiceAccountDelegationInfo_ThirdPartyPrincipal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccountDelegationInfo.ThirdPartyPrincipal', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..aOM<$7.Struct>(1, _omitFieldNames ? '' : 'thirdPartyClaims', subBuilder: $7.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $7.Struct get thirdPartyClaims => $_getN(0);
  @$pb.TagNumber(1)
  set thirdPartyClaims($7.Struct v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasThirdPartyClaims() => $_has(0);
  @$pb.TagNumber(1)
  void clearThirdPartyClaims() => clearField(1);
  @$pb.TagNumber(1)
  $7.Struct ensureThirdPartyClaims() => $_ensure(0);
}
...
class ServiceAccountDelegationInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceAccountDelegationInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class LogSplit extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'LogSplit', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.audit.v1'), createEmptyInstance: create)
