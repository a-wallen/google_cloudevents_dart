...
class BuildEventData_Status extends $pb.ProtobufEnum {
  static const BuildEventData_Status STATUS_UNKNOWN = BuildEventData_Status._(0, _omitEnumNames ? '' : 'STATUS_UNKNOWN');
  static const BuildEventData_Status QUEUED = BuildEventData_Status._(1, _omitEnumNames ? '' : 'QUEUED');
  static const BuildEventData_Status WORKING = BuildEventData_Status._(2, _omitEnumNames ? '' : 'WORKING');
  static const BuildEventData_Status SUCCESS = BuildEventData_Status._(3, _omitEnumNames ? '' : 'SUCCESS');
  static const BuildEventData_Status FAILURE = BuildEventData_Status._(4, _omitEnumNames ? '' : 'FAILURE');
  static const BuildEventData_Status INTERNAL_ERROR = BuildEventData_Status._(5, _omitEnumNames ? '' : 'INTERNAL_ERROR');
  static const BuildEventData_Status TIMEOUT = BuildEventData_Status._(6, _omitEnumNames ? '' : 'TIMEOUT');
  static const BuildEventData_Status CANCELLED = BuildEventData_Status._(7, _omitEnumNames ? '' : 'CANCELLED');
  static const BuildEventData_Status EXPIRED = BuildEventData_Status._(9, _omitEnumNames ? '' : 'EXPIRED');
