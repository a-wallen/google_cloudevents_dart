...
import '../../../../type/latlng.pb.dart' as $25;
...
class EntityEventData extends $pb.GeneratedMessage {
  ...
  factory EntityEventData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EntityEventData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
    ..aOM<EntityResult>(1, _omitFieldNames ? '' : 'value', subBuilder: EntityResult.create)
    ..aOM<EntityResult>(2, _omitFieldNames ? '' : 'oldValue', subBuilder: EntityResult.create)
    ..aOM<PropertyMask>(3, _omitFieldNames ? '' : 'updateMask', subBuilder: PropertyMask.create)
  ...
  'Will be removed in next major version')
  EntityEventData copyWith(void Function(EntityEventData) updates) => super.copyWith((message) => updates(message as EntityEventData)) as EntityEventData;
  ...
  static $pb.PbList<EntityEventData> createRepeated() => $pb.PbList<EntityEventData>();
  @$core.pragma('dart2js:noInline')
  static EntityEventData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EntityEventData>(create);
  ...
  @$pb.TagNumber(1)
  set value(EntityResult v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set oldValue(EntityResult v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set updateMask(PropertyMask v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class PropertyMask extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PropertyMask', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
...
class EntityResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
...
class PartitionId extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PartitionId', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
...
class Key_PathElement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Key.PathElement', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
...
class Key extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Key', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
...
class ArrayValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ArrayValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
    ...
    ..aOM<$25.LatLng>(8, _omitFieldNames ? '' : 'geoPointValue', subBuilder: $25.LatLng.create)
    ...
    ..e<$7.NullValue>(11, _omitFieldNames ? '' : 'nullValue', $pb.PbFieldType.OE, defaultOrMaker: $7.NullValue.NULL_VALUE, valueOf: $7.NullValue.valueOf, enumValues: $7.NullValue.values)
  ...
  @$pb.TagNumber(8)
  $25.LatLng get geoPointValue => $_getN(5);
  @$pb.TagNumber(8)
  set geoPointValue($25.LatLng v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasGeoPointValue() => $_has(5);
  @$pb.TagNumber(8)
  void clearGeoPointValue() => clearField(8);
  @$pb.TagNumber(8)
  $25.LatLng ensureGeoPointValue() => $_ensure(5);
  ...
  /// A null value.
  @$pb.TagNumber(11)
  $7.NullValue get nullValue => $_getN(8);
  @$pb.TagNumber(11)
  set nullValue($7.NullValue v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class Entity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Entity', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
    ..aOM<Key>(1, _omitFieldNames ? '' : 'key', subBuilder: Key.create)
    ..m<$core.String, Value>(3, _omitFieldNames ? '' : 'properties', entryClassName: 'Entity.PropertiesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Value.create, valueDefaultOrMaker: Value.getDefault, packageName: const $pb.PackageName('google.events.cloud.datastore.v1'))
    ..hasRequiredFields = false
  ;
