...
class EntityCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EntityCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datastore.v1'), createEmptyInstance: create)
    ..aOM<$26.EntityEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $26.EntityEventData.create)
  ...
  @$pb.TagNumber(1)
  $26.EntityEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($26.EntityEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $26.EntityEventData ensureData() => $_ensure(0);
}
