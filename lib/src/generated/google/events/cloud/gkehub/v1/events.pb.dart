...
class MembershipCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MembershipCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.gkehub.v1'), createEmptyInstance: create)
    ..aOM<$33.MembershipEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $33.MembershipEventData.create)
  ...
  @$pb.TagNumber(1)
  $33.MembershipEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($33.MembershipEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $33.MembershipEventData ensureData() => $_ensure(0);
}
...
class FeatureCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FeatureCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.gkehub.v1'), createEmptyInstance: create)
    ..aOM<$33.FeatureEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $33.FeatureEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $33.FeatureEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($33.FeatureEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $33.FeatureEventData ensureData() => $_ensure(0);
}
...
class ScopeCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScopeCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.gkehub.v1'), createEmptyInstance: create)
    ..aOM<$33.ScopeEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $33.ScopeEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $33.ScopeEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($33.ScopeEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $33.ScopeEventData ensureData() => $_ensure(0);
}
...
class MembershipBindingCreatedEvent extends $pb.GeneratedMessage {
  factory MembershipBindingCreatedEvent({
    $33.MembershipBindingEventData? data,
  }) {
    final $result = create();
    if (data != null) {
      $result.data = data;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MembershipBindingCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.gkehub.v1'), createEmptyInstance: create)
    ..aOM<$33.MembershipBindingEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $33.MembershipBindingEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $33.MembershipBindingEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($33.MembershipBindingEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $33.MembershipBindingEventData ensureData() => $_ensure(0);
}
