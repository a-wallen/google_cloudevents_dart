...
class InstanceCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datafusion.v1'), createEmptyInstance: create)
    ..aOM<$23.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $23.InstanceEventData.create)
  ...
  @$pb.TagNumber(1)
  $23.InstanceEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($23.InstanceEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $23.InstanceEventData ensureData() => $_ensure(0);
}
...
class DnsPeeringCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DnsPeeringCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.datafusion.v1'), createEmptyInstance: create)
    ..aOM<$23.DnsPeeringEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $23.DnsPeeringEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $23.DnsPeeringEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($23.DnsPeeringEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $23.DnsPeeringEventData ensureData() => $_ensure(0);
}
