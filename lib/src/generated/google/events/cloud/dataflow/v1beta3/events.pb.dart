...
class JobStatusChangedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobStatusChangedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOM<$22.JobEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $22.JobEventData.create)
  ...
  @$pb.TagNumber(1)
  $22.JobEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($22.JobEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $22.JobEventData ensureData() => $_ensure(0);
}
