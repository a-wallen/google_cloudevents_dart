...
class Environment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Environment', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOM<$7.Struct>(5, _omitFieldNames ? '' : 'userAgent', subBuilder: $7.Struct.create)
    ..aOM<$7.Struct>(6, _omitFieldNames ? '' : 'version', subBuilder: $7.Struct.create)
    ..aOS(7, _omitFieldNames ? '' : 'dataset')
    ..aOM<$7.Struct>(8, _omitFieldNames ? '' : 'sdkPipelineOptions', subBuilder: $7.Struct.create)
  ...
  @$pb.TagNumber(5)
  $7.Struct get userAgent => $_getN(4);
  @$pb.TagNumber(5)
  set userAgent($7.Struct v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUserAgent() => $_has(4);
  @$pb.TagNumber(5)
  void clearUserAgent() => clearField(5);
  @$pb.TagNumber(5)
  $7.Struct ensureUserAgent() => $_ensure(4);

  /// A structure describing which components and their versions of the service
  /// are required in order to run the job.
  @$pb.TagNumber(6)
  $7.Struct get version => $_getN(5);
  @$pb.TagNumber(6)
  set version($7.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasVersion() => $_has(5);
  @$pb.TagNumber(6)
  void clearVersion() => clearField(6);
  @$pb.TagNumber(6)
  $7.Struct ensureVersion() => $_ensure(5);
  ...
  /// independent way.
  @$pb.TagNumber(8)
  $7.Struct get sdkPipelineOptions => $_getN(7);
  @$pb.TagNumber(8)
  set sdkPipelineOptions($7.Struct v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSdkPipelineOptions() => $_has(7);
  @$pb.TagNumber(8)
  void clearSdkPipelineOptions() => clearField(8);
  @$pb.TagNumber(8)
  $7.Struct ensureSdkPipelineOptions() => $_ensure(7);
