...
class RemoteConfigEventData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteConfigEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.remoteconfig.v1'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'versionNumber')
    ..aOM<$2.Timestamp>(2, _omitFieldNames ? '' : 'updateTime', subBuilder: $2.Timestamp.create)
    ..aOM<RemoteConfigUser>(3, _omitFieldNames ? '' : 'updateUser', subBuilder: RemoteConfigUser.create)
    ..aOS(4, _omitFieldNames ? '' : 'description')
    ..e<RemoteConfigUpdateOrigin>(5, _omitFieldNames ? '' : 'updateOrigin', $pb.PbFieldType.OE, defaultOrMaker: RemoteConfigUpdateOrigin.REMOTE_CONFIG_UPDATE_ORIGIN_UNSPECIFIED, valueOf: RemoteConfigUpdateOrigin.valueOf, enumValues: RemoteConfigUpdateOrigin.values)
    ..e<RemoteConfigUpdateType>(6, _omitFieldNames ? '' : 'updateType', $pb.PbFieldType.OE, defaultOrMaker: RemoteConfigUpdateType.REMOTE_CONFIG_UPDATE_TYPE_UNSPECIFIED, valueOf: RemoteConfigUpdateType.valueOf, enumValues: RemoteConfigUpdateType.values)
  ...
  'Will be removed in next major version')
  RemoteConfigEventData copyWith(void Function(RemoteConfigEventData) updates) => super.copyWith((message) => updates(message as RemoteConfigEventData)) as RemoteConfigEventData;
...
class RemoteConfigUser extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RemoteConfigUser', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.firebase.remoteconfig.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RemoteConfigUser copyWith(void Function(RemoteConfigUser) updates) => super.copyWith((message) => updates(message as RemoteConfigUser)) as RemoteConfigUser;
