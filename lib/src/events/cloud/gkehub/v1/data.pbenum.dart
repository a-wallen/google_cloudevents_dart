...
class ScopeLifecycleState_Code extends $pb.ProtobufEnum {
  static const ScopeLifecycleState_Code CODE_UNSPECIFIED = ScopeLifecycleState_Code._(0, _omitEnumNames ? '' : 'CODE_UNSPECIFIED');
  static const ScopeLifecycleState_Code CREATING = ScopeLifecycleState_Code._(1, _omitEnumNames ? '' : 'CREATING');
  static const ScopeLifecycleState_Code READY = ScopeLifecycleState_Code._(2, _omitEnumNames ? '' : 'READY');
  static const ScopeLifecycleState_Code DELETING = ScopeLifecycleState_Code._(3, _omitEnumNames ? '' : 'DELETING');
  static const ScopeLifecycleState_Code UPDATING = ScopeLifecycleState_Code._(4, _omitEnumNames ? '' : 'UPDATING');

  static const $core.List<ScopeLifecycleState_Code> values = <ScopeLifecycleState_Code> [
    CODE_UNSPECIFIED,
    CREATING,
    READY,
    DELETING,
  ...
  static final $core.Map<$core.int, ScopeLifecycleState_Code> _byValue = $pb.ProtobufEnum.initByValue(values);
...
class MembershipBindingLifecycleState_Code extends $pb.ProtobufEnum {
  static const MembershipBindingLifecycleState_Code CODE_UNSPECIFIED = MembershipBindingLifecycleState_Code._(0, _omitEnumNames ? '' : 'CODE_UNSPECIFIED');
  static const MembershipBindingLifecycleState_Code CREATING = MembershipBindingLifecycleState_Code._(1, _omitEnumNames ? '' : 'CREATING');
  static const MembershipBindingLifecycleState_Code READY = MembershipBindingLifecycleState_Code._(2, _omitEnumNames ? '' : 'READY');
  static const MembershipBindingLifecycleState_Code DELETING = MembershipBindingLifecycleState_Code._(3, _omitEnumNames ? '' : 'DELETING');
  static const MembershipBindingLifecycleState_Code UPDATING = MembershipBindingLifecycleState_Code._(4, _omitEnumNames ? '' : 'UPDATING');

  static const $core.List<MembershipBindingLifecycleState_Code> values = <MembershipBindingLifecycleState_Code> [
    CODE_UNSPECIFIED,
    CREATING,
    READY,
    DELETING,
  ...
  static final $core.Map<$core.int, MembershipBindingLifecycleState_Code> _byValue = $pb.ProtobufEnum.initByValue(values);
  static MembershipBindingLifecycleState_Code? valueOf($core.int value) => _byValue[value];

  const MembershipBindingLifecycleState_Code._($core.int v, $core.String n) : super(v, n);
}
