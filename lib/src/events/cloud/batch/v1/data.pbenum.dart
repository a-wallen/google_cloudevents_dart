...
class TaskStatus_State extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, TaskStatus_State> _byValue =
...
class LifecyclePolicy_Action extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, LifecyclePolicy_Action> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class LogsPolicy_Destination extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, LogsPolicy_Destination> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class JobNotification_Type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, JobNotification_Type> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class AllocationPolicy_ProvisioningModel extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, AllocationPolicy_ProvisioningModel>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static AllocationPolicy_ProvisioningModel? valueOf($core.int value) =>
      _byValue[value];

  const AllocationPolicy_ProvisioningModel._($core.int v, $core.String n)
      : super(v, n);
}
...
class TaskGroup_SchedulingPolicy extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, TaskGroup_SchedulingPolicy> _byValue =
      $pb.ProtobufEnum.initByValue(values);
