...
class CloudBuildEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'CloudBuildEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.cloudbuild.v1'), createEmptyInstance: create)
    ..aOM<$33.BuildEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $33.BuildEventData.create)
  ...
  @$pb.TagNumber(1)
  $33.BuildEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($33.BuildEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $33.BuildEventData ensureData() => $_ensure(0);
}
