...
class FunctionCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FunctionCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ..aOM<$52.FunctionEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $52.FunctionEventData.create)
  ...
  @$pb.TagNumber(1)
  $52.FunctionEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($52.FunctionEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $52.FunctionEventData ensureData() => $_ensure(0);
}
