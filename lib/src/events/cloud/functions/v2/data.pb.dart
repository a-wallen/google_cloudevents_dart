...
class Function_ extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Function', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(8, _omitFieldNames ? '' : 'labels', entryClassName: 'Function.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.events.cloud.functions.v2'))
...
class StateMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StateMessage', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class StorageSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StorageSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class RepoSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RepoSource', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
...
class Source extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Source', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class SourceProvenance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SourceProvenance', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class BuildConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'BuildConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(6, _omitFieldNames ? '' : 'environmentVariables', entryClassName: 'BuildConfig.EnvironmentVariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.events.cloud.functions.v2'))
...
class ServiceConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ServiceConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'service')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'timeoutSeconds', $pb.PbFieldType.O3)
    ..m<$core.String, $core.String>(4, _omitFieldNames ? '' : 'environmentVariables', entryClassName: 'ServiceConfig.EnvironmentVariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.events.cloud.functions.v2'))
...
class SecretEnvVar extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecretEnvVar', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class SecretVolume_SecretVersion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecretVolume.SecretVersion', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class SecretVolume extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SecretVolume', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class EventTrigger extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventTrigger', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class EventFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EventFilter', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
...
class FunctionEventData extends $pb.GeneratedMessage {
  ...
  factory FunctionEventData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory FunctionEventData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FunctionEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.functions.v2'), createEmptyInstance: create)
    ..aOM<Function_>(1, _omitFieldNames ? '' : 'payload', subBuilder: Function_.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FunctionEventData copyWith(void Function(FunctionEventData) updates) => super.copyWith((message) => updates(message as FunctionEventData)) as FunctionEventData;
  ...
  static $pb.PbList<FunctionEventData> createRepeated() => $pb.PbList<FunctionEventData>();
  @$core.pragma('dart2js:noInline')
  static FunctionEventData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<FunctionEventData>(create);
  ...
  @$pb.TagNumber(1)
  set payload(Function_ v) { setField(1, v); }
  @$pb.TagNumber(1)
