...
class JobExecutedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$35.SchedulerJobData>(1, _omitFieldNames ? '' : 'data',
        subBuilder: $35.SchedulerJobData.create)
  ...
  @$pb.TagNumber(1)
  $35.SchedulerJobData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($35.SchedulerJobData v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $35.SchedulerJobData ensureData() => $_ensure(0);
}
