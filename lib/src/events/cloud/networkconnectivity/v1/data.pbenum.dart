...
class Infrastructure extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, Infrastructure> _byValue =
...
class ConnectionErrorType extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, ConnectionErrorType> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class ServiceConnectionMap_ConsumerPscConfig_State extends $pb.ProtobufEnum {
  ...
  static final $core
      .Map<$core.int, ServiceConnectionMap_ConsumerPscConfig_State> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static ServiceConnectionMap_ConsumerPscConfig_State? valueOf(
          $core.int value) =>
      _byValue[value];

  const ServiceConnectionMap_ConsumerPscConfig_State._(
...
class ServiceConnectionMap_ConsumerPscConnection_State
  ...
  static final $core
      .Map<$core.int, ServiceConnectionMap_ConsumerPscConnection_State>
...
class ServiceConnectionPolicy_State extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, ServiceConnectionPolicy_State> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static ServiceConnectionPolicy_State? valueOf($core.int value) =>
      _byValue[value];

  const ServiceConnectionPolicy_State._($core.int v, $core.String n)
      : super(v, n);
}
