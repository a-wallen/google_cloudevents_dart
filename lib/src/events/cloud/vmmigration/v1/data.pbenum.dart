...
class MigrationWarning_WarningCode extends $pb.ProtobufEnum {
  static const MigrationWarning_WarningCode WARNING_CODE_UNSPECIFIED = MigrationWarning_WarningCode._(0, _omitEnumNames ? '' : 'WARNING_CODE_UNSPECIFIED');
  static const MigrationWarning_WarningCode ADAPTATION_WARNING = MigrationWarning_WarningCode._(1, _omitEnumNames ? '' : 'ADAPTATION_WARNING');

  static const $core.List<MigrationWarning_WarningCode> values = <MigrationWarning_WarningCode> [
    WARNING_CODE_UNSPECIFIED,
    ADAPTATION_WARNING,
  ];

  static final $core.Map<$core.int, MigrationWarning_WarningCode> _byValue = $pb.ProtobufEnum.initByValue(values);
  static MigrationWarning_WarningCode? valueOf($core.int value) => _byValue[value];

  const MigrationWarning_WarningCode._($core.int v, $core.String n) : super(v, n);
}
