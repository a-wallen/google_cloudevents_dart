...
class RuntimeCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RuntimeCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOM<$54.RuntimeEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $54.RuntimeEventData.create)
  ...
  @$pb.TagNumber(1)
  $54.RuntimeEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($54.RuntimeEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $54.RuntimeEventData ensureData() => $_ensure(0);
}
...
class InstanceCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOM<$54.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $54.InstanceEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $54.InstanceEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($54.InstanceEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $54.InstanceEventData ensureData() => $_ensure(0);
}
...
class EnvironmentCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'EnvironmentCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOM<$54.EnvironmentEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $54.EnvironmentEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $54.EnvironmentEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($54.EnvironmentEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $54.EnvironmentEventData ensureData() => $_ensure(0);
}
...
class ScheduleDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ScheduleDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOM<$54.ScheduleEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $54.ScheduleEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $54.ScheduleEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($54.ScheduleEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $54.ScheduleEventData ensureData() => $_ensure(0);
}
...
class ExecutionDeletedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExecutionDeletedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOM<$54.ExecutionEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $54.ExecutionEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  /// The data associated with the event.
  @$pb.TagNumber(1)
  $54.ExecutionEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($54.ExecutionEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $54.ExecutionEventData ensureData() => $_ensure(0);
}
