...
class ServingState extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, ServingState> _byValue =
...
class CertificateIssuanceConfig_KeyAlgorithm extends $pb.ProtobufEnum {
  ...
  const CertificateIssuanceConfig_KeyAlgorithm._($core.int v, $core.String n)
      : super(v, n);
}
...
class Certificate_Scope extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, Certificate_Scope> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class Certificate_ManagedCertificate_State extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, Certificate_ManagedCertificate_State>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static Certificate_ManagedCertificate_State? valueOf($core.int value) =>
      _byValue[value];

  const Certificate_ManagedCertificate_State._($core.int v, $core.String n)
      : super(v, n);
}
...
class Certificate_ManagedCertificate_ProvisioningIssue_Reason
  ...
  static final $core
      .Map<$core.int, Certificate_ManagedCertificate_ProvisioningIssue_Reason>
      _byValue = $pb.ProtobufEnum.initByValue(values);
...
class CertificateMapEntry_Matcher extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, CertificateMapEntry_Matcher> _byValue =
      $pb.ProtobufEnum.initByValue(values);
  static CertificateMapEntry_Matcher? valueOf($core.int value) =>
      _byValue[value];

  const CertificateMapEntry_Matcher._($core.int v, $core.String n)
      : super(v, n);
}
