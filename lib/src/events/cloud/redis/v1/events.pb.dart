...
class InstanceCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InstanceCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.redis.v1'), createEmptyInstance: create)
    ..aOM<$28.InstanceEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $28.InstanceEventData.create)
  ...
  @$pb.TagNumber(1)
  $28.InstanceEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($28.InstanceEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $28.InstanceEventData ensureData() => $_ensure(0);
}
