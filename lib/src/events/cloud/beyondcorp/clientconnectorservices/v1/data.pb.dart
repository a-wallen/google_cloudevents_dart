...
class ClientConnectorService_Ingress_Config_DestinationRoute extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorService.Ingress.Config.DestinationRoute', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
...
class ClientConnectorService_Ingress_Config extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorService.Ingress.Config', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
...
class ClientConnectorService_Ingress extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorService.Ingress', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class ClientConnectorService_Egress_PeeredVpc extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorService.Egress.PeeredVpc', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
...
class ClientConnectorService_Egress extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorService.Egress', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class ClientConnectorService extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorService', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
...
class ClientConnectorServiceEventData extends $pb.GeneratedMessage {
  ...
  factory ClientConnectorServiceEventData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ClientConnectorServiceEventData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientConnectorServiceEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientconnectorservices.v1'), createEmptyInstance: create)
    ..aOM<ClientConnectorService>(1, _omitFieldNames ? '' : 'payload', subBuilder: ClientConnectorService.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ClientConnectorServiceEventData clone() => ClientConnectorServiceEventData()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClientConnectorServiceEventData copyWith(void Function(ClientConnectorServiceEventData) updates) => super.copyWith((message) => updates(message as ClientConnectorServiceEventData)) as ClientConnectorServiceEventData;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ClientConnectorServiceEventData create() => ClientConnectorServiceEventData._();
  ClientConnectorServiceEventData createEmptyInstance() => create();
  static $pb.PbList<ClientConnectorServiceEventData> createRepeated() => $pb.PbList<ClientConnectorServiceEventData>();
  @$core.pragma('dart2js:noInline')
  static ClientConnectorServiceEventData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ClientConnectorServiceEventData>(create);
  ...
  @$pb.TagNumber(1)
  set payload(ClientConnectorService v) { setField(1, v); }
  @$pb.TagNumber(1)
