...
class AppConnection_Type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, AppConnection_Type> _byValue =
...
class AppConnection_State extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, AppConnection_State> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class AppConnection_Gateway_Type extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, AppConnection_Gateway_Type> _byValue =
      $pb.ProtobufEnum.initByValue(values);
