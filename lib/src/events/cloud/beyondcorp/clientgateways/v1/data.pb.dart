...
class ClientGateway extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientGateway', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientgateways.v1'), createEmptyInstance: create)
...
class ClientGatewayEventData extends $pb.GeneratedMessage {
  ...
  factory ClientGatewayEventData.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ClientGatewayEventData.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClientGatewayEventData', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.beyondcorp.clientgateways.v1'), createEmptyInstance: create)
    ..aOM<ClientGateway>(1, _omitFieldNames ? '' : 'payload', subBuilder: ClientGateway.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ClientGatewayEventData clone() => ClientGatewayEventData()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClientGatewayEventData copyWith(void Function(ClientGatewayEventData) updates) => super.copyWith((message) => updates(message as ClientGatewayEventData)) as ClientGatewayEventData;
  ...
  static $pb.PbList<ClientGatewayEventData> createRepeated() => $pb.PbList<ClientGatewayEventData>();
  @$core.pragma('dart2js:noInline')
  static ClientGatewayEventData getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ClientGatewayEventData>(create);
  ...
  @$pb.TagNumber(1)
  set payload(ClientGateway v) { setField(1, v); }
  @$pb.TagNumber(1)
