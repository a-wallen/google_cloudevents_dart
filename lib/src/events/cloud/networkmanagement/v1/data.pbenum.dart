...
class GoogleServiceInfo_GoogleServiceType extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, GoogleServiceInfo_GoogleServiceType>
      _byValue = $pb.ProtobufEnum.initByValue(values);
  static GoogleServiceInfo_GoogleServiceType? valueOf($core.int value) =>
      _byValue[value];

  const GoogleServiceInfo_GoogleServiceType._($core.int v, $core.String n)
      : super(v, n);
}
...
class LoadBalancerBackend_HealthCheckFirewallState extends $pb.ProtobufEnum {
  ...
  static final $core
      .Map<$core.int, LoadBalancerBackend_HealthCheckFirewallState> _byValue =
      $pb.ProtobufEnum.initByValue(values);
