...
class JobCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.video.transcoder.v1'), createEmptyInstance: create)
    ..aOM<$20.JobEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $20.JobEventData.create)
  ...
  @$pb.TagNumber(1)
  set data($20.JobEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class JobTemplateCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'JobTemplateCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.video.transcoder.v1'), createEmptyInstance: create)
    ..aOM<$20.JobTemplateEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $20.JobTemplateEventData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set data($20.JobTemplateEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
