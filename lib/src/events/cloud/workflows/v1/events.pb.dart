...
class WorkflowCreatedEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'WorkflowCreatedEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'google.events.cloud.workflows.v1'), createEmptyInstance: create)
    ..aOM<$34.WorkflowEventData>(1, _omitFieldNames ? '' : 'data', subBuilder: $34.WorkflowEventData.create)
  ...
  @$pb.TagNumber(1)
  $34.WorkflowEventData get data => $_getN(0);
  @$pb.TagNumber(1)
  set data($34.WorkflowEventData v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasData() => $_has(0);
  @$pb.TagNumber(1)
  void clearData() => clearField(1);
  @$pb.TagNumber(1)
  $34.WorkflowEventData ensureData() => $_ensure(0);
}
